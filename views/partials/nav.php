            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <?php if ($_SESSION['user'] ?? false) : ?>
                            <button type="button"
                                    class="relative flex max-w-xs items-center bg-gray-800 text-sm"
                        ...
                        <?php else : ?>
                            <a href="/register"
                               class="<?= urlIs('/register') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium mr-3">Register</a>
                            <a href="/login"
